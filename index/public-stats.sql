...
group by profiles.user_id, profiles.username, profiles.accent_color, profiles.is_public, profiles.favorite_game, profiles.selected_medals, profiles.bio, profiles.platform, profiles.country, profiles.level, profiles.status, profiles.game_progress, profiles.medal_earned_at, profiles.previous_rank, profiles.created_at, profiles.icon_url, profiles.avatar_url
