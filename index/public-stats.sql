...
group by profiles.user_id, profiles.username, profiles.accent_color, profiles.is_public, profiles.favorite_game, profiles.selected_medals, profiles.created_at, profiles.icon_url
